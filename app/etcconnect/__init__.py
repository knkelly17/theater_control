'''Initialization of the etcconnect blueprint for the Flask application.'''
from flask import Blueprint

# 1. Define the blueprint object
# 'etcconnect' is the name used for url_for)
etcconnect_bp = Blueprint(
    'etcconnect', 
    __name__,
...
from . import etcconnect_routes # pylint: disable=wrong-import-position
